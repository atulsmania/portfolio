...
const ParallaxBackground = () => {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 w-full h-4/5 overflow-hidden dark:bg-light-grid bg-dark-grid -z-10 [mask-image:linear-gradient(0deg,transparent,rgba(0,0,0,.5),#000)]"
    />
  );
};
