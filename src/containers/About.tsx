      ...
      <Timeline.Item align="left" year="2020">
        <div className="p-4 font-medium rounded bg-neutral-400/10">
          ...
          <div className="mt-8">
            ...
            to solve it. The paper covered topics such as the causes of traffic
            congestion, and possible solutions to reduce congestion. Built a
            small chat application as well as focused on solving Data Structures
            and Algorithms (DSA) problems using Java.
          </div>
        </div>
      </Timeline.Item>
      <Timeline.Item align="right" year="2021">
        <div className="p-4 font-medium rounded bg-neutral-400/10">
          ...
          <div className="mt-8">
            ...
            developers, providing guidance and mentoring to improve their skills
            and productivity.
          </div>
        </div>
      </Timeline.Item>
